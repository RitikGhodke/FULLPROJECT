  ...
  return (
    <div className="profileWrap">
      <style>{`
        ...
        .profileInner { max-width: 800px; margin: 0 auto; }
        .backBtn {
          padding: 10px 18px; background: rgba(255,255,255,0.2); color: #fff;
          border: none; border-radius: 8px; cursor: pointer; font-weight: 600;
          margin-bottom: 16px; backdrop-filter: blur(10px); font-size: 14px;
        }
        .profileCard {
        ...
        .profileName { font-size: 22px; font-weight: 800; color: #1e293b; margin-bottom: 4px; }
        .fieldLabel { display: block; margin-bottom: 8px; font-weight: 600; color: #1e293b; font-size: 13px; }
        .fieldInput {
          width: 100%; padding: 13px 14px; border: 2px solid #e2e8f0; border-radius: 10px;
          font-size: 15px; outline: none; box-sizing: border-box; transition: all 0.3s ease;
        }
        .actionRow { display: flex; gap: 10px; flex-wrap: wrap; }
        .actionRow button { flex: 1; min-width: 130px; padding: 13px; border-radius: 10px; border: none; cursor: pointer; font-weight: 600; font-size: 15px; }
        ...
        .statBox {
          background: rgba(255,255,255,0.95); padding: 14px 8px; border-radius: 12px;
          text-align: center; backdrop-filter: blur(10px);
        }
        .statBox .emoji { font-size: 24px; margin-bottom: 6px; }
        .statBox .lbl { font-size: 11px; color: #64748b; margin-bottom: 3px; }
        .statBox .val { font-size: 18px; font-weight: 800; }
        ...
        @media (min-width: 640px) {
          .profileWrap { padding: 40px 20px; }
          .profileCard { padding: 40px; }
          .statsGrid { grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; }
          .statBox { padding: 20px; }
          .statBox .val { font-size: 24px; }
        }
      `}</style>
      ...
      <div className="profileInner">
        ...
        <div className="profileCard">
          ...
          <div style={{ maxWidth: 500, margin: "0 auto" }}>
              ...
              {!editing ? (
                ...
                <>
                  <button
                    onClick={handleSave}
                    disabled={loading}
                    style={{ background: loading ? "#94a3b8" : "#059669", color: "#fff", cursor: loading ? "not-allowed" : "pointer" }}
                  >
                    {loading ? "Saving..." : "💾 Save Changes"}
                  </button>
                  <button
            ...
            <button
              onClick={handleLogout}
              style={{
                width: "100%", marginTop: 20, padding: "13px", background: "#fee2e2",
                color: "#dc2626", border: "2px solid #fecaca", borderRadius: 10,
        ...
        <div className="statsGrid">
          <div className="statBox">
            ...
            <div className="lbl">AI Robots</div>
            <div className="val" style={{ color: "#667eea" }}>{stats.activeRobots}</div>
          </div>
          <div className="statBox">
            <div className="emoji">💰</div>
            <div className="lbl">Total Profit</div>
            <div className="val" style={{ color: "#059669" }}>₹{stats.totalEarned}</div>
          </div>
          <div className="statBox">
            <div className="emoji">📈</div>
            <div className="lbl">Active Days</div>
            <div className="val" style={{ color: "#0891b2" }}>{stats.activeDays}</div>
          </div>
        </div>
      </div>
    </div>
