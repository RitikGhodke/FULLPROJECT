  ...
  return (
    <div className="dashWrap">
      ...
      <style>{`
        ...
        .headerCard h1 { font-size: 24px; font-weight: 800; color: #1e293b; margin-bottom: 4px; }
        .headerCard p { color: #64748b; font-size: 14px; }

        /* Stats: horizontal snap-scroll on mobile, grid on desktop */
        .statsRow {
          display: flex;
          gap: 14px;
          overflow-x: auto;
        ...
        .statCard .value { font-size: 30px; font-weight: 800; }
        ...
        /* Purchases: cards on mobile, table on desktop */
        .purchasesCard {
          background: #fff;
          border-radius: 16px;
          padding: 20px;
        ...
        .purchasesCard h2 { font-size: 20px; font-weight: 700; color: #1e293b; margin-bottom: 16px; }
        ...
        .purchaseTile .row { display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px; }
        .purchaseTile .name { font-weight: 700; color: #1e293b; font-size: 15px; }
        .purchaseTile .amount { font-weight: 700; color: #667eea; font-size: 15px; }
        .purchaseTile .meta { font-size: 12px; color: #64748b; }
        ...
        .actionBar button, .actionBar a button {
          flex: 1;
          padding: 14px;
          border: none;
          border-radius: 12px;
        ...
        .btnWithdraw { background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: #fff; }
        .btnHistory { background: #667eea; color: #fff; }

        .emptyState { text-align: center; padding: 48px 16px; color: #94a3b8; }
        .browseBtn {
        ...
        @media (min-width: 720px) {
          ...
          .actionBar button, .actionBar a button { flex: unset; width: auto; padding: 16px 32px; }
      ...
      <div className="dashInner">
        ...
        <div className="statsRow">
          <div className="statCard primaryStat">
            <div className="label" style={{ opacity: 0.9 }}>Wallet Balance</div>
            <div className="value">₹{walletBalance}</div>
          </div>
          <div className="statCard secondaryStat">
            <div className="label" style={{ color: "#64748b" }}>Total Purchases</div>
            <div className="value" style={{ color: "#1e293b" }}>{purchases.length}</div>
          </div>
          <div className="statCard secondaryStat">
            <div className="label" style={{ color: "#64748b" }}>Active Robots</div>
        ...
        <div className="actionBar">
          <button className="btnWithdraw" onClick={() => setShowWithdrawalModal(true)}>
            💰 Withdrawal Request
          </button>
          <Link to="/withdrawal-history" style={{ flex: 1 }}>
        ...
        <div className="purchasesCard">
          ...
          {purchases.length === 0 ? (
            <div className="emptyState">
              ...
              <div style={{ fontSize: 17, fontWeight: 600 }}>No purchases yet</div>
              <p style={{ marginTop: 6 }}>Start investing in AI Robots to see them here!</p>
            ...
            <>
              ...
              <div className="mobileList">
                {purchases.map((purchase, idx) => (
                  <div className="purchaseTile" key={idx}>
                    <div className="row">
                      <span className="name">{purchase.productName}</span>
                    ...
                    <div className="meta" style={{ marginTop: 4, fontFamily: "monospace" }}>
                      {purchase.razorpayPaymentId}
                    </div>
                  </div>
                ))}
              ...
              <div className="desktopTable" style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  ...
                  <tbody>
                    {purchases.map((purchase, idx) => (
                      <tr key={idx} style={{ borderBottom: "1px solid #f1f5f9" }}>
                        <td style={{ padding: "16px", fontWeight: 600, color: "#1e293b" }}>{purchase.productName}</td>
                        <td style={{ padding: "16px", fontWeight: 700, color: "#667eea" }}>₹{purchase.amount}</td>
                        <td style={{ padding: "16px", fontSize: 13, color: "#64748b", fontFamily: "monospace" }}>
                          {purchase.razorpayPaymentId}
                        </td>
                        <td style={{ padding: "16px", fontSize: 14, color: "#64748b" }}>
                        ...
                        <td style={{ padding: "16px" }}>{getStatusBadge(purchase.status)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
