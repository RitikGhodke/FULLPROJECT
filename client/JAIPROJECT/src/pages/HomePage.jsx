...
//       padding: "40px 20px"
//     }}>
//       {/* Responsive style for stats grid */}
//       <style>{`
//         .stats-grid {
//           display: grid;
  ...
  return (
    <div className="homeWrap">
      <style>{`
        ...
        .heroBox { max-width: 1200px; margin: 0 auto 28px; text-align: center; }
        .heroTitle {
          font-size: clamp(26px, 6vw, 48px);
          font-weight: 800; color: #fff; margin-bottom: 10px;
          text-shadow: 0 2px 10px rgba(0,0,0,0.2);
        }
        .heroSub { font-size: clamp(14px, 3vw, 18px); color: rgba(255,255,255,0.9); max-width: 600px; margin: 0 auto; }
        ...
        .daysBadge {
          ...
          background: rgba(255,255,255,0.95); padding: 5px 10px; border-radius: 20px;
          font-size: 11px; font-weight: 700; color: #667eea;
        }
        .productBody { padding: 16px; }
        .productName { font-size: 18px; font-weight: 700; color: #1e293b; margin-bottom: 10px; }

        .stats-grid {
          display: grid; grid-template-columns: 1fr 1fr;
          gap: 10px; margin-bottom: 14px; padding: 10px 0;
          border-top: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0;
        }
        .stats-grid .maturity-cell { grid-column: 1 / -1; }
        .statLabel { font-size: 11px; color: #64748b; margin-bottom: 3px; }
        .statValue { font-size: 15px; font-weight: 700; }

        .priceRow { display: flex; justify-content: space-between; align-items: center; gap: 10px; }
        .investLabel { font-size: 12px; color: #64748b; margin-bottom: 2px; }
        .investValue { font-size: 24px; font-weight: 800; color: #667eea; }
        .buyBtn {
          background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
        ...
        .roiBadge {
          margin-top: 10px; padding: 8px 10px; background: #f0fdf4; border-radius: 8px;
          text-align: center; font-size: 12px; color: #166534; font-weight: 600;
        }

        .footerCta {
          max-width: 1200px; margin: 40px auto 0; text-align: center;
          padding: 30px 16px; background: rgba(255,255,255,0.1); border-radius: 16px;
        }
        .footerCta h2 { color: #fff; margin-bottom: 10px; font-size: 22px; }
        .footerCta p { color: rgba(255,255,255,0.8); font-size: 14px; }

        @media (min-width: 640px) {
          .productGrid { grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 24px; }
          .homeWrap { padding: 40px 20px; }
          .productImgWrap { height: 220px; }
          .productBody { padding: 20px; }
          .stats-grid { grid-template-columns: 1fr 1fr 1fr; }
          .investValue { font-size: 28px; }
        }
      `}</style>

      <div className="heroBox">
        <h1 className="heroTitle">🤖 AI Robots Marketplace</h1>
        <p className="heroSub">Invest in AI Robots and earn daily profits automatically</p>
      </div>
          ...
          <div key={p.id} className="productCard">
            <div className="productImgWrap">
              <img
                ...
                onError={e => e.target.src = "/images/placeholder.jpg"}
              />
              <div className="daysBadge">{p.validityDays} Days</div>
            </div>
            ...
            <div className="productBody">
              ...
              <div className="stats-grid">
                <div>
                  <div className="statLabel">Daily Profit</div>
                  <div className="statValue" style={{ color: "#059669" }}>
                    ₹{Number(p.dailyProfit).toFixed(2)}
                  </div>
                </div>
                <div>
                  <div className="statLabel">Total Profit</div>
                  <div className="statValue" style={{ color: "#0891b2" }}>₹{p.totalProfit}</div>
                </div>
                <div className="maturity-cell">
                  <div className="statLabel">Maturity Amount</div>
                  <div className="statValue" style={{ color: "#7c3aed" }}>₹{p.price + p.totalProfit}</div>
                </div>
              </div>

              <div className="priceRow">
                <div>
                  <div className="investLabel">Investment</div>
                  <div className="investValue">₹{p.price}</div>
                </div>
                <Link to={`/payment/${p.id}`} className="buyBtn">Buy Now →</Link>
              </div>

              <div className="roiBadge">
                🎯 ROI: {Math.round((p.totalProfit / p.price) * 100)}% in {p.validityDays} days
              </div>
            </div>
          </div>
      ...
      <div className="footerCta">
        ...
        <p>Choose your AI Robot and watch your investment grow daily</p>
      </div>
    </div>
  );
}